...
// 		const e = lolkek;
// 		e= 1;
// 		resultTwo.textContent = 'Функция вызвана без ошибок', e;
// 	}
// 	//Блок catch
// 	catch(error) {
...
// 	let inputData = -1;
// 		if (inputData < 0)
// 		throw new Error("Нельзя вводить число меньше ноля")
...
// 	}
// 	catch (error) {
// 		document.querySelector('#result9').innerHTML= 1;
// 	}
// }
...
// 	}}
// 	catch(error){
// 		document.getElementById('result10').textContent = `Email-адрес некорректен`+  error.name;
// 	}
...
// 	} catch (error) {
// 		//Ваш код
// 		resultSixteen.textContent = error.name;
// 	}
// }
...
// function makeTwenty() {
// 	const resultA = document.getElementById('result20');
// 	const resultB = document.getElementById('result20a');

// 	try{
// 		resultA.textContent = calculateValue();
// 	}
// 	catch(error){
// 		console.error(error);
// 		resultA.textContent = 'Ошибка';
// 	}
// 	finally{
// 		resultB.textContent= "finally20";
// 	}
// }
...
// 	const resultA = document.getElementById('result21');
// 		const resultB = document.getElementById('result21a');

// 		try{
// 			resultA.textContent = fetchData();
// 		}
// 		catch(error){
// 			console.error(error);
// 			resultA.textContent = 'Ошибка';
...
// 	}
// 	catch(error){
// 		resultTwentyThree.textContent="Ошибка";
...
// 		resultTwentyFive.textContent = 'Извините, '+ error.message;
// 	}
// }
...
// 	catch(error){
// 		console.error(error.message);
// 		resultTwentySix.textContent = 'Извините, '+ error.message;
// 	}
// }
...
// 	catch(error){
// 		console.error(error.message);
// 		resultTwentySeven.textContent = 'Извините, '+ error.message;
// 	}
// }

// document.querySelector('.b-27').addEventListener('click', simulateAsyncOperation);
